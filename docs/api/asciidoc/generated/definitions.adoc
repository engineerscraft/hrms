...
|**grade** +
__required__|Name of the grade model|<<_grademodel,GradeModel>>
|**jobRoleId** +
...
|**organization** +
__required__|Name of the organization model|<<_organizationmodel,OrganizationModel>>
...
|Name|Description|Schema
|**maxAllowLimit** +
__optional__|The maximum allowable limit.|number (double)
|**optSalaryComponent** +
__required__|The Salary component.|<<_salaryoptcomponentmodel,SalaryOptComponentModel>>
|**salaryValue** +
...
|**frequency** +
__required__|Frequency of the component.|integer (int(32))
|**optCompId** +
...
**Maximal length** : `32`|string (varchar)
|**optType** +
__required__|Optional component type.|integer (int(32))
|**salOptComponent** +
__optional__|Salary componenet. +
**Maximal length** : `32`|string (varchar)
|===
