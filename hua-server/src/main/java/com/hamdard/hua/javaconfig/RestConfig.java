...
public class RestConfig extends ResourceConfig {
    public RestConfig() {
        registerClasses(AccountResource.class, AuthenticationEndpoint.class, AuthenticationFilter.class, AuthorizationFilter.class, HealthCheckEndpoint.class, PermissionEndpoint.class);
    }
}