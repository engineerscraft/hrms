...
public enum Privilege {
    ...
    CREATE_A_USER,
    MODIFY_BASIC_DTLS_OF_AN_EMP,
    MODIFY_ADDL_DTLS_OF_AN_EMP,
    MODIFY_ADDR_DTLS_OF_AN_EMP,
    READ_PAYSLIP_OF_AN_EMP, 
    INSERT_PAYSLIP_OF_AN_EMP,
    READ_SALARYSTACK_OF_AN_EMP,
    READ_LEAVE_OF_AN_EMP,
    UPDATE_LEAVE_OF_AN_EMP,
    UPDATE_ALL_OPT_BENEFIT_FOR_AN_EMP,
