...
public class JobRoleRepository {
	private static final Logger logger = LogManager
			.getLogger(JobRoleRepository.class);
	...
	public List<JobRole> getJobRolesByOrgId(int orgId) {
		...
		List<JobRole> jobRoles = (List<JobRole>) jdbcTemplate.query(
				jobroleGetByOrgIdSql, new Object[] { orgId },
				new JobRoleRowMapper());
	...
	public List<Salary> getSalaryByJobRoleId(long jobRoleId) {
		...
		List<Salary> salary = (List<Salary>) jdbcTemplate.query(
				salaryGetByJobRoleIdSql, new Object[] { jobRoleId },
				new SalaryRowMapper());
	...
	public List<Salary> getOptionalBenefitsByJobRoleId(long jobRoleId) {
		...
		logger.info(sqlMarker, "Params {}", () -> jobRoleId);
		List<Salary> optBenefits = (List<Salary>) jdbcTemplate.query(
				OptBenefitsGetByJobRoleIdSql, new Object[] { jobRoleId },
				new SalaryRowMapper());
