...
CREATE SEQUENCE HRMS.EMP_ADL_DETL_HIST_SEQ START WITH 1 INCREMENT BY 1 CACHE 5 CYCLE;

CREATE TABLE HRMS.EMPLOYEE_ADDITIONAL_DETAILS_HISTORY (	
	EMP_ADL_DETL_HIST_ID BIGINT PRIMARY KEY DEFAULT NEXTVAL('HRMS.EMP_ADL_DETL_HIST_SEQ'),
	EMP_ID	VARCHAR(20),
	NO_OF_SIBLINGS	INT,
	NO_OF_DEPENDENT	INT,
	NOMINEE_NAME1	VARCHAR(120),
...
CREATE SEQUENCE HRMS.EMP_HIERARCHY_STATUS_HIST_SEQ START WITH 1 INCREMENT BY 1 CACHE 5 CYCLE;	

CREATE TABLE HRMS.EMPLOYEE_HIERARCHY_STATUS_HISTORY	(	
	EMP_HIERARCHY_STATUS_HIST_ID BIGINT PRIMARY KEY DEFAULT NEXTVAL('HRMS.EMP_HIERARCHY_STATUS_HIST_SEQ'),
	EMP_ID VARCHAR(20) PRIMARY KEY,
	SUPERVISOR_ID INT,
	HR_ID INT,
	STATUS VARCHAR(4),
