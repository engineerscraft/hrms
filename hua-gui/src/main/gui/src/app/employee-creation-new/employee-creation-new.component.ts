...
@Component({
  ...
  templateUrl: './employee-creation-new.component.html',
  styleUrls: ['./employee-creation-new.component.css']
})
export class EmployeeCreationNewComponent implements OnInit {
